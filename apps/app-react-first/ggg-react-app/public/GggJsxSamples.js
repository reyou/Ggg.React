...
// http://localhost:3000/GggExamples.html
...
//=============================================================================
var componentsDefinedAsClassesFun = function () {
    ...
    ReactDOM.render(<SignUpDialog></SignUpDialog>, document.getElementById("componentsDefinedAsClassesFun"));
}
//
componentsDefinedAsClassesFun();
//=============================================================================
var specializationFun = function () {
    function Dialog(props) {
        return (
            <FancyBorder color="blue">
                <div className="Dialog-title">
...
let splitFun = function () {
    ...
    ReactDOM.render(<App></App>, document.getElementById("splitFun"));
}
splitFun();
//
//=============================================================================
...
let compositionFun = function () {
    ...
    ReactDOM.render(<WelcomeDialog></WelcomeDialog>,
        document.getElementById("compositionFun"));
}
//
compositionFun();
//=============================================================================
...
var liftingStateUpFun = function () {
    ...
    ReactDOM.render(<Calculator></Calculator>, document.getElementById("liftingStateUpFun"));
}
//
liftingStateUpFun();
//=============================================================================
var multipleInputsFun = function () {
    class Reservation extends React.Component {
        ...
        render() {
            return (<div>
                ...
                <div>
                    <b>Is Going: </b><span>{this.state.isGoing ? "Yes" : "No"}</span>
                </div>
                <div>
                    <b>Number of guests: </b><span>{this.state.numberOfGuests}</span>
                </div>
            </div>);
        }
    }
    ReactDOM.render(<Reservation></Reservation>, document.getElementById("multipleInputsFun"));
}
//
multipleInputsFun();
//=============================================================================
var selectFun = function () {
    ...
    ReactDOM.render(<FlavorForm></FlavorForm>, document.getElementById("selectFun"));
}
//
selectFun();
//=============================================================================
var textAreaFun = function () {
    ...
    ReactDOM.render(<EssayForm></EssayForm>, document.getElementById("textAreaFun"));
}
// 
textAreaFun();
//=============================================================================
...
var formsFun = function () {
    ...
    ReactDOM.render(<NameForm></NameForm>, document.getElementById("formsFun"));
}
//
formsFun();
//=============================================================================
var embeddingExpressionsFun = function () {
...
var siblingsFun = function () {
    ...
    ReactDOM.render(<Blog posts={posts} />, document.getElementById('siblingsFun'));
}
//
siblingsFun();
//=============================================================================
